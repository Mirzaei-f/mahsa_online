...
const Signup = () => {
    ...
    //  const {setname,setlastname,}=useContext(Context)
        ...
        <View  style={s` form space-y-2  `}>
            ...
            <Formik 
                ...
                initialValues={{phone: '',name:'',family:''}}
                 ...
                 // setname(values.name)
                  setasync('name',values.name)
                  setasync('lastname',values.family)
                
    console.log("nameeeeesignup",values.name)
    console.log("lastnameeeeesignup",values.name)
